...
public class Medico {
	...
	//constuctor
	public Medico(long id_medico, long id_consultorio, long id_especialidad, String usermedic, String tipodocumento,
	...
	public String getUsermedic() {
		return usermedic;
	}

	public void setUsermedic(String usermedic) {
		this.usermedic = usermedic;
	}
